...
const index = ({ currentUser , tickets  })=>{
    const ticketList = tickets.map((ticket)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(next_link__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
async function getServerSideProps(context) {
    const { data  } = await (0,_api_ingressInstance__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(context).get("/api/users/currentuser");
    const { data: tickets  } = await (0,_api_ingressInstance__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(context).get("/api/tickets");
    return {
        props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,544], () => (__webpack_exec__(3678)));
